...
<body>
    <a name="top" <ul>
        <li><a href="http://127.0.0.1:5500/fr2.html" target="_self">Second Page</a></li>
        <li><a href="#top1">Paragraph 1</a> <a href="#top2">Paragraph2</a> <a href="#top3">Paragraph3</a> <a
                href="#top4">Paragraph4</a></li>
        </ul>
        <h1 align="center" style="font-size:200%" id="top1">What is Lorem Ipsum?</h1>
        <p style="font-style:oblique" style="font-weight:bolder"><b>Lorem Ipsum</b> is simply dummy text of the printing
            ...
            of
            Lorem Ipsum.</p>
        <h2 align="center" style="font-size:200%" id="top2">Why do we use it?</h2>
        <a href="#top">Go to first paragraph</a>
        <p style="font-style:italic">It is a long established fact that a reader will be
        ...
        <h3 align="center" style="font-size:200%" id="top3">Where does it come from?</h3>
        <a href="#top">Go to first paragraph</a>
        ...
        <h4 align="center" style="font-size:200%" id="top4">Where can I get some?</h4>
        <a href="#top">Go to first paragraph</a>
        <p style="font-style:italic">There are many variations of passages of Lorem Ipsum
